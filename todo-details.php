...
todo editting Page -> allows the user to edit a singular todo entry at a time.
-->
 ...
 <html lang="en-ca">
	...
	<body>
		...
		<main>
          ...
          <div class="container">
            <h1>TODO Details</h1>
            <form action="./assets/php/update-db-entry.php" method="post" id="edit-todo">
              ...
              <div clas="form-group">
                ...
                <div class="col-lg-10">
                  <!-- checks the checkbox if db lists as completed -->
